...
<body class="">
    ...
    <div class="global-wrapper">
	    ...
	    <section id="client">
	        ...
	        <section class="client-hero" data-stellar-background-ratio="0.5" style="background: url({{ asset('/images/uploads/yogatoday-top-bg.jpg') }});" > 
	            <header id="header">
				    <div class="container wider">
					    <div class="row">
		        ...
		        <div class="hero container">
			        <img src="{{ asset('/images/uploads/yt-logo.png') }}" class="client-logo" alt="Yoga Today" title="Yoga Today"/>
		    ...
		    <section id="client-content" class="no-title">
			    <div class="container">
				    <div class="row visible-xs">
					    <div class="col-md-12"> <h1>Yoga Today</h1> </div>
				    </div>
				    <div class="row">
						<div class="col-md-4 col-sm-4">
                          <p class="top-line">It's like having daily yoga instruction delivered to your computer (or mobile device). YogaToday was a full rethink of how yogis (novice and advanced alike) train and interact with their computers. Not everyone who practices has the ability to be near a computer when they are in their training space. We created a system that requires minimum interaction from the user and functions as a subscription video</p>				    </div>
					    <div class="col-md-4 col-sm-4">
                          <p>delivery service, rather than a more complicated website that could detract from the focus necessary to train as deeply as they may like. The finished site is simple, responsive, and beautiful. It gets the user to their full screen yoga training session quickly and makes it as hard as possible to be distracted. In the case that someone does get distracted, it is their own fault. Just legally trying to be in the right, here. </p>
					    </div>
					    <div class="col-md-4 col-sm-4 service-rendered-wrap">
						    ...
						    <a href="http://yogatoday.com/" class="link-button no-arrow dark sans" target="_blank"> Launch Project </a>					    </div>
				    </div>
			    </div>
					...
					<div class="row">
					    <div class="col-md-12">
					        <div class="item-shots pull-up" style=" ">
							    <img src="{{ asset('/images/uploads/yt-home.jpg') }}" alt="Class design for Yoga Today" title="Class design for Yoga Today" />
						    </div>
					    </div>
				    </div>   
					<div class="row">
					    <div class="col-md-8 col-md-offset-2">
					        <p>The user is free to select previous videos, but is immediately brought into the daily video of the day. There's no messing around - you get right into it. </p>
					    </div>
				    </div>
					<div class="row">
					    <div class="col-md-12">
					        <div class="item-shots pull-up" style=" ">
							    <img src="{{ asset('/images/uploads/yt-landing.jpg') }}" alt="Sign up page design" title="Sign up page design" />
						    </div>
					    </div>
				    </div>   
					<div class="row">
					    <div class="col-md-8 col-md-offset-2">
					        <p>The site was designed to be very responsive to whatever mobile device is used. If your location moves quickly and frequently, you now have instruction that can follow you. </p>
					    </div>
				    </div>   					  
			    </div>  
		    </section> <!-- #client-content -->
		    ...
		    <section class="client-nav">
			    <div class="container">
				    <div class="row">
					    ...
					    <a href="clinica-vida-bem-vinda" class="col-md-6 col-sm-6 col-xs-6 previous"> <span class="arrow"><small>Previous</small> <span>Clínica VidaBemVinda</span></span> </a>	
					 
					 
					    <a href="digitalundivided" class="col-md-6 col-sm-6 col-xs-6 align-right next pull-right"> <span class="arrow"><small>Next</small> <span>digitalundivided</span></span> </a>	
				    </div>
			    </div>
		    </section> <!-- .client-nav -->
@endsection