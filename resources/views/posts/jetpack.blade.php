		    ...
		    <section class="client-nav">
			    <div class="container">
				    <div class="row">
					    ...
					    <a href="clinica-vida-bem-vinda" class="col-md-6 col-sm-6 col-xs-6 align-right next pull-right"> <span class="arrow"><small>Next</small> <span>Clínica VidaBemVinda</span></span> </a>	
				    </div>
			    </div>
		    </section> <!-- .client-nav -->
@endsection