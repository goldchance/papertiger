...
<body class="">
    ...
    <div class="global-wrapper">
	    ...
	    <section id="client">
	        ...
	        <section class="client-hero" data-stellar-background-ratio="0.5" style="background: url({{ asset('/images/uploads/vydia-banner.jpg') }});" > 
	            <header id="header">
				    <div class="container wider">
					    <div class="row">
		        ...
		        <div class="hero container">
			        <img src="{{ asset('/images/uploads/vydia.png') }}" class="client-logo" alt="" title=""/>
		    ...
		    <section id="client-content" class="no-title">
			    <div class="container">
				    <div class="row visible-xs">
					    <div class="col-md-12"> <h1>Vydia</h1> </div>
				    </div>
				    <div class="row">
						<div class="col-md-4 col-sm-4">
                          <p class="top-line">Monetization Meets Discovery. Vydia helps artists of all levels monetize and promote their visual content in one easy to use platform. We drew from our extensive past experience in the music industry to understand and help translate Vydia's vision into a great new site.</p>				    </div>
					    <div class="col-md-4 col-sm-4">
                          <p>The resulting site needs to be seen to be believed. It's alive and awake with background video and delicately planned transitions. Most importantly, it explains an exceptional product to artists and labels whop greatly benefit from it.</p>
					    </div>
					    <div class="col-md-4 col-sm-4 service-rendered-wrap">
						    	...
						    	<div class="row the-list">
						    		<div class="col-md-6">
						    			<ul class="list">
									     	...
									     	<li> + <a style="color:#3bbeee;" href="branding" data-loader-position="right">Branding Services</a> </li>
									     											   
										 
									     	<li> + <a style="color:#3bbeee;" href="consulting" data-loader-position="right">Consulting</a> </li>
									     											   
										 
									     	<li> + <a style="color:#3bbeee;" href="design" data-loader-position="right">Design</a> </li>
						    		...
						    		<div class="col-md-6">
						    			<ul class="list">
									     	...
									     	<li> + <a style="color:#3bbeee;" href="development" data-loader-position="right">Development</a> </li>
										   									     
									     	<li> + <a style="color:#3bbeee;" href="design8455" data-loader-position="right">Usability</a> </li>
						    ...
						    <a href="http://vydia.com/" class="link-button no-arrow dark sans" target="_blank"> Launch Project </a>					    </div>
				    </div>
			    </div>
		    ...
		    <section class="client-content pull-up">
			    <div class="container">		    
					...
					<div class="row">
					    <div class="col-md-12">
					        <div class="item-shots pull-up" style=" ">
							    <img src="{{ asset('/images/uploads/vydia-responsive.jpg') }}" alt="" title="" />
						    </div>
					    </div>
				    </div>   
					...
					<div class="row">
					    <div class="col-md-12">
					        <div class="item-shots pull-up" style=" ">
							    <img src="{{ asset('/images/uploads/Vydia-home.jpg') }}" alt="" title="" />
						    </div>
					    </div>
				    </div>   
		    ...
		    <section class="client-nav">
			    <div class="container">
				    <div class="row">
					    <a href="the-new-york-times" class="col-md-6 col-sm-6 col-xs-6 align-right next pull-right"> <span class="arrow"><small>Next</small> <span>The New York Times</span></span> </a>	
				    </div>
			    </div>
		    </section> <!-- .client-nav -->
@endsection